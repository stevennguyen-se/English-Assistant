 ...
 *
 */
public class FragmentGeneralChartWeekCombine extends Fragment {
	...
	public FragmentGeneralChartWeekCombine() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = localInflater.inflate(R.layout.fragment_general_chart_week_combine,
				container, false);
...
//		listUserAttributeStatistic = new ArrayList<UserStatisticGeneral>();
	...
	class FragmentGeneralChartCombineAdapter extends FragmentPagerAdapter implements IconPagerAdapter {
		...
		public Fragment getItem(int arg0) {
			...
			if (arg0 == 0) {
				listUserAttributeStatistic = userStatisticDatabaseAdapter.getUserStatisticAttributeByWeek(3);
				fragment = new FragmentGeneralChart(listUserAttributeStatistic, "Overview Chart", "Days Of Week", "Number of Words");
			} else if (arg0 == 1) {
				listUserAttributeStatistic = userStatisticDatabaseAdapter.getUserStatisticAttributeByWeek(2);
				fragment = new FragmentGeneralChart(listUserAttributeStatistic, "Overview Chart", "Days Of Week", "Number of Words");
			} else if (arg0 == 2) {
				listUserAttributeStatistic = userStatisticDatabaseAdapter.getUserStatisticAttributeByWeek(1);
				fragment = new FragmentGeneralChart(listUserAttributeStatistic, "Overview Chart", "Days Of Week", "Number of Words");
			} else if (arg0 == 3) {
				listUserAttributeStatistic = userStatisticDatabaseAdapter.getUserStatisticAttributeByWeek(0);
				fragment = new FragmentGeneralChart(listUserAttributeStatistic, "Overview Chart", "Days Of Week", "Number of Words");
			} 
			return fragment;
		}
